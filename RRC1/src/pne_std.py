...
length_matrix = standard_scaling(length_matrix)
ratio_matrix = standard_scaling(ratio_matrix)
lanes_matrix = standard_scaling(lanes_matrix)
...
for beta1_init in np.linspace(-10, 0, 10):  # Wider range for grid search
    for beta2_init in np.linspace(-10, 0, 10):
        for beta3_init in np.linspace(-10, 0, 10):
